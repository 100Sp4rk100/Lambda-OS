...
void HistogramController::updateHorizontalIndexAfterSelectingNewSeries(
   ...
   *           _ _ _ _
   * series2: | | | | |
   *             ^ LAMDA_gray_light_palette index 1 when moving down
   *
   * But in the case where bars do not start on the same spot, selected index
   * should be offsetted so that you always LAMDA_gray_light_palette the bar just above or under
   ...
   *             _ _ _
   * series2:   | | | |
   *             ^ LAMDA_gray_light_palette index 0 when moving down
   *
