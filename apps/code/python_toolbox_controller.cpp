...
constexpr ToolboxMessageTree TimeModuleChildren[] = {
    ...
    ToolboxMessageTree::Leaf(I18n::Message::PythonCommandGetTime,
                             I18n::Message::PythonGetTime),
    ToolboxMessageTree::Leaf(I18n::Message::PythonCommandSetTime,
                             I18n::Message::PythonSetTime),
    ToolboxMessageTree::Leaf(I18n::Message::PythonCommandResetTime,
                             I18n::Message::PythonResetTime)
    };
