...
void PythonTextArea::ContentView::drawLine(KDContext *ctx, int line,
  ...
  if (firstNonSpace != text) {
    ...
    drawStringAt(ctx, line, fromColumn, spacesStart,
                 ...
                 StringColor, Theme::ThemeGestion::getColor("KDColorWhite"), selectionStart, selectionEnd,
  ...
  if (nlr_push(&nlr) == 0) {
    ...
    while (lex->tok_kind != MP_TOKEN_NEWLINE && lex->tok_kind != MP_TOKEN_END) {
      ...
      drawStringAt(ctx, line,
                   ...
                   tokenFrom, tokenLength, color, Theme::ThemeGestion::getColor("KDColorWhite"),
                   selectionStart, selectionEnd, Theme::ThemeGestion::getColor("Select"));
    ...
    if (tokenFrom < text + byteLength) {
      ...
      drawStringAt(
          ...
          Theme::ThemeGestion::getColor("KDColorWhite"), selectionStart, selectionEnd, Theme::ThemeGestion::getColor("Select"));
    }
  ...
  if (m_autocomplete && autocompleteStart >= text &&
    ...
    drawStringAt(
        ...
        AutocompleteColor, Theme::ThemeGestion::getColor("KDColorWhite"), nullptr, nullptr, Theme::ThemeGestion::getColor("Select"));
  }
}
