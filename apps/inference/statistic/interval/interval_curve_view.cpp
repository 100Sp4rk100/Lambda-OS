...
void IntervalPlotPolicy::drawPlot(const AbstractPlotView* plotView,
  ...
  for (int i = 0; i < Interval::k_numberOfDisplayedIntervals; i++) {
    ...
    Print::CustomPrintf(
        ...
        PlotPolicy::AbstractLabeledAxis::k_numberSignificantDigits);
    KDColor textColor =
        isMainInterval ? Theme::ThemeGestion::getColor("KDColorBlack") : Theme::ThemeGestion::getColor("GrayDarkMiddle");
    plotView->drawLabel(
    ...
    KDColor intervalColor = isMainInterval ? Theme::ThemeGestion::getColor("YellowDark")
                                           : Theme::ThemeGestion::getColor("GrayDarkMiddle");
