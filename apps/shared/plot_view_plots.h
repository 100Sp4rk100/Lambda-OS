...
class WithCurves {
 protected:
   ...
   * 1 # 0 #        X . . .
   * # 3 # 2        . X . .
   * FIXME For now, Theme::ThemeGestion::getColor("Theme::ThemeGestion::getColor("KDColorWhite")") is used as a shorthand for transparency, since
  ...
  class Pattern {
   public:
    ...
    Pattern(KDColor c0, KDColor c1, KDColor c2, KDColor c3,
            KDColor cBackground = Theme::ThemeGestion::getColor("KDColorWhite"));
    Pattern(KDColor c = Theme::ThemeGestion::getColor("KDColorWhite")) : Pattern(c, c, c, c, c) {}
    Pattern(bool s0, bool s1, bool s2, bool s3, KDColor color,
            KDColor backgroundColor = Theme::ThemeGestion::getColor("KDColorWhite"));
    Pattern(int s, KDColor color, KDColor backgroundColor = Theme::ThemeGestion::getColor("KDColorWhite"));
  ...
  class HistogramDrawing {
   public:
    HistogramDrawing(Curve1D curve, void *model, void *context,
                     ...
                     KDColor borderColor = Theme::ThemeGestion::getColor("KDColorWhite"));
    void draw(const AbstractPlotView *plotView, KDContext *ctx,
              KDRect rect) const;
