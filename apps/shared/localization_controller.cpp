...
LocalizationController::ContentView::ContentView(
  ...
  m_countryTitleMessage.setBackgroundColor(Theme::ThemeGestion::getColor("WallScreen"));
  ...
  for (int i = 0; i < k_numberOfCountryWarningLines; i++) {
    m_countryWarningLines[i].setBackgroundColor(Theme::ThemeGestion::getColor("WallScreen"));
    m_countryWarningLines[i].setFont(KDFont::Size::Small);
    m_countryWarningLines[i].setTextColor(Theme::ThemeGestion::getColor("GrayDark"));
